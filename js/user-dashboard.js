        ...
        if (nextAdventureSection) {
            nextAdventureSection.innerHTML = `
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-10 text-center">
                    ...
                    <a href="../destinations.html" class="inline-block bg-blue-600 text-white px-6 py-2.5 md:px-8 md:py-3 rounded-full font-bold text-sm md:text-base hover:bg-blue-700 transition shadow-lg shadow-blue-200/50 hover:scale-105 active:scale-95 transition-all duration-300">
